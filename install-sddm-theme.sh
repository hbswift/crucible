...
sudo sed -i 's|^Background="Backgrounds/[^"]*"|Background="Backgrounds/fern.jpg"|' /usr/share/sddm/themes/sddm-astronaut-theme/Themes/fern.conf 

echo "Set new theme as default..."
sudo sed -i 's|^ConfigFile=Themes/[^ ]*|ConfigFile=Themes/fern.conf|' /usr/share/sddm/themes/sddm-astronaut-theme/metadata.desktop
